...
<script>
    ...
    myLabel.index       = '<?php echo admin_url('question/onLoadDatatableEventHandler');?>';
    myLabel.status      = '<?php echo admin_url('question/onChangeStatusEventHandler');?>';
    myLabel.delete      = '<?php echo admin_url('question/delete');?>';
    myLabel.edit        = '<?php echo admin_url('question/edit/');?>';
</script>