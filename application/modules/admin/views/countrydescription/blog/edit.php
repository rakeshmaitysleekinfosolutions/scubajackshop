                                ...
                                if($images) {
                                    foreach ($images as $image) {?>
                                        <tr id="image-row<?php echo $imageRow;?>">
                                            ...
                                            <td>
                                                <input type="text" class="form-control video" placeholder="Video Url" name="images[<?php echo $imageRow;?>][video]" value="<?php echo $image['video'];?>" data-placeholder="Video URL">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="images[<?php echo $imageRow;?>][sort_order]" value="<?php echo $image['sort_order'];?>" data-placeholder="Sort Order">
                                            </td>
