<div class="content container-fluid">
    <form id="frmSignUp" action="<?php echo admin_url('countrydescription/update/'.$primaryKey);?>" method="post">
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-8">
                <h4 class="page-title">Edit Country Content</h4>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if(!empty($countries)) {
                                foreach ($countries as $country) {?>
                                        <option value="<?php echo $country->id;?>" <?php echo  ($country->id == $countryId) ? "selected" : ""?>><?php echo $country->name;?></option>
                                <?php } ?>
                            <?php } ?>
                            </select>
                        </div>
