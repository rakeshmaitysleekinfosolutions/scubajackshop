<div class="content container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8 col-xs-9 text-right m-b-20">
            ...
            <a href="<?php echo admin_url('continent/create');?>" class="btn btn-primary rounded pull-right"><i class="fa fa-plus"></i> Add Continent</a>
...
<script>
    ...
    myLabel.index   = '<?php echo admin_url('continent/onLoadDatatableEventHandler');?>';
    myLabel.delete   = '<?php echo admin_url('continent/delete');?>';
    myLabel.edit    = '<?php echo admin_url('continent/edit/');?>';
</script>