<div class="content container-fluid">
    <form id="frm" action="<?php echo admin_url('country/store');?>" method="post">
                        ...
                        <div class="">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="iso_code_2" id="input-iso_code_2" autocomplete="off" value="<?php echo $name;?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
