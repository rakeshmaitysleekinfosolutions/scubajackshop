<div class="content container-fluid">
    <form id="frm" action="<?php echo admin_url('worksheet/store');?>" method="post">
        <div class="row">
                                    ...
                                    foreach ($worksheets as $worksheet) {?>
                                        <tr id="data-row<?php echo $counter;?>">
                                            <td class="text-left">
                                                ...
                                                <input type="hidden" name="worksheets[<?php echo $counter;?>][data]" value="<?php echo $worksheet['thumb'];?>" id="input-data<?php echo $counter;?>>"/>
                                            </td>
                                            <td>
                                                <input type="text" placeholder="Title" name="worksheets[<?php echo $counter;?>][title]" data-placeholder="Title">
                                            </td>
                                            <td>
                                                <input type="text" name="worksheets[<?php echo $counter;?>][sort_order]" data-placeholder="Sort Order">
                                            </td>
